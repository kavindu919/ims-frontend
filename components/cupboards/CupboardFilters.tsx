...
interface FilterProps {
  query: CupboardQueryProps;
  setQuery: React.Dispatch<React.SetStateAction<CupboardQueryProps>>;
}

const CupboardFilters = ({ setQuery, query }: FilterProps) => {
  const handleChange = (
...
export default CupboardFilters;
